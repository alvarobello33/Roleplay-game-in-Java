...
public final class ApiHelper {
     ...
     *
     * @throws PersistenceException If your computer doesn't support SSL at all. If you get this exception when calling the
     *                     constructor, contact the OOPD teachers.
     */
    public ApiHelper() throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException("Error launching GET method to the API.", e);
        }
    }
     ...
     * @throws PersistenceException If the URL is malformed or the server can't be reached.
     */
    public String getFromUrl(String url) throws PersistenceException {
        try {
            // Define the request
     ...
     * @throws PersistenceException If the URL is malformed or the server can't be reached.
     */
    public String postToUrl(String url, String body) throws PersistenceException {
        try {
            // Define the request
            ...
            // Exceptions are simplified for any classes that need to catch them
            throw new PersistenceException("Error launching POST method to the API.", e);
        }
    }
     ...
     * @throws PersistenceException If the URL is malformed or the server can't be reached.
     */
    public String deleteFromUrl(String url) throws PersistenceException {
        try {
            // Define the request
            // The default method is GET, so we don't need to specify it (but we could do so by calling .GET() before .build()
            // The HttpRequest.Builder pattern offers a ton of customization for the request (headers, body, HTTP version...)
            ...
            // Exceptions are simplified for any classes that need to catch them
            throw new PersistenceException("Error launching DELETE method to the API.", e);
        }
    }
